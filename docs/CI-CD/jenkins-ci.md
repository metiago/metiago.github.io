...
<img src="/images/site/ci/git_plugin.png" width="auto">
...
<img src="/images/site/ci/git_ssh.png" width="auto">
...
<img src="/images/site/ci/git_public_key.png" width="auto">

In order to be able to trigger Jenkins' jobs, we should generate a Jenkins token. 

<img src="/images/site/ci/jenkins_token.png" width="auto">
...
<img src="/images/site/ci/git_webhook.png" width="auto">

Next step, create a job and set the SCM.

<img src="/images/site/ci/job_git.png" width="auto">

and then the Build Triggers

<img src="/images/site/ci/job_trigger.png" width="auto">
...
<img src="/images/site/ci/job_build.png" width="auto">
...
<img src="/images/site/ci/job_started.png" width="auto">

After the build, we're able to see the code quality analysis on SonarQube.

<img src="/images/site/ci/sonar_report.png" width="auto">
