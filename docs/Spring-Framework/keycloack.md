...
<img src="/images/site/keycloack/add_realm.png" width="auto" >

- Create a new client application setting the `redirect_uris` to `http://localhost:8080/sso/login`
<img src="/images/site/keycloack/add_app.png" width="auto" >

- Create a new user 
<img src="/images/site/keycloack/add_user.png" width="auto" >

- Set a password for this user on the credentials tab
<img src="/images/site/keycloack/add_user_password.png" width="auto" >

- Create a new role called `user` e.g
<img src="/images/site/keycloack/add_role.png" width="auto" >

- Assign this role for the user
<img src="/images/site/keycloack/assign_role.png" width="auto" >
