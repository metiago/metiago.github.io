...
date: 2020-05-07T19:18:41-03:00
draft: false
---
...
<img src="/images/site/spring-cloud/gateway-keycloack/add-user.png" width="auto" >

<img src="/images/site/spring-cloud/gateway-keycloack/add-user-password.png" width="auto" >

Create a realm.

<img src="/images/site/spring-cloud/gateway-keycloack/add-realm.png" width="auto" >

Create a client scope.

<img src="/images/site/spring-cloud/gateway-keycloack/client-scope.png" width="auto" >

Create two clients with the same configuration, one called `has-game-scope` and other called `no-game-scope`.

<img src="/images/site/spring-cloud/gateway-keycloack/add-client.png" width="auto" >

Assign the scope `GAME` for the client called `has-game-scope`.

<img src="/images/site/spring-cloud/gateway-keycloack/assign-scope.png" width="auto" >
...
<img src="/images/site/spring-cloud/gateway-keycloack/diagram.png" width="auto" >
