...
send many events to it.

 `solc-js` and the other one is `web3j`

In order to create a new blockchain peer we have to these files `Dockerfile` and `genesis.json`. This 
will create a new Geth instance with a new account.
...
Before start executing transactions in our private blockchain we have to deploy a contract. Contracts works as an agreement between peers using the application. 
...
All Restful APIs was built in Eclipse Vert.x making use of websockets.
...
<img src="{{site.github.url}}/assets/img/daap/eth-graphana.png" width="100%" height="100%"/>

<img src="{{site.github.url}}/assets/img/daap/new-account.png" width="100%" height="100%"/>

<img src="{{site.github.url}}/assets/img/daap/login.png" width="100%" height="100%"/>

<img src="{{site.github.url}}/assets/img/daap/accounts.png" width="100%" height="100%"/>

<img src="{{site.github.url}}/assets/img/daap/accounts-mileages.png" width="100%" height="100%"/>

<img src="{{site.github.url}}/assets/img/daap/transaction-logs.png" width="100%" height="100%"/>

<img src="{{site.github.url}}/assets/img/daap/wallet.png" width="100%" height="100%"/>
