...
<img src="{{site.github.url}}/assets/img/keycloack/add_realm.png" width="100%" height="100%"/>

- Create a new client application setting the `redirect_uris` to `http://localhost:8080/sso/login`
<img src="{{site.github.url}}/assets/img/keycloack/add_app.png" width="100%" height="100%"/>

- Create a new user 
<img src="{{site.github.url}}/assets/img/keycloack/add_user.png" width="100%" height="100%"/>

- Set a password for this user on the credentials tab
<img src="{{site.github.url}}/assets/img/keycloack/add_user_password.png" width="100%" height="100%"/>

- Create a new role called `user` e.g
<img src="{{site.github.url}}/assets/img/keycloack/add_role.png" width="100%" height="100%"/>

- Assign this role for the user
<img src="{{site.github.url}}/assets/img/keycloack/assign_role.png" width="100%" height="100%"/>
