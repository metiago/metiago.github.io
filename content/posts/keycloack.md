...
{{< figure src="/img/keycloack/add_realm.png" width="auto" >}}

- Create a new client application setting the `redirect_uris` to `http://localhost:8080/sso/login`
{{< figure src="/img/keycloack/add_app.png" width="auto" >}}

- Create a new user 
{{< figure src="/img/keycloack/add_user.png" width="auto" >}}

- Set a password for this user on the credentials tab
{{< figure src="/img/keycloack/add_user_password.png" width="auto" >}}

- Create a new role called `user` e.g
{{< figure src="/img/keycloack/add_role.png" width="auto" >}}

- Assign this role for the user
{{< figure src="/img/keycloack/assign_role.png" width="auto" >}}
