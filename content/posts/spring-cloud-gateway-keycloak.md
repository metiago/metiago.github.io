...
<img src="{{site.github.url}}/assets/img/spring-cloud/gateway-keycloack/add-user.png" width="100%" height="100%"/>

<img src="{{site.github.url}}/assets/img/spring-cloud/gateway-keycloack/add-user-password.png" width="100%" height="100%"/>

Create a realm.

<img src="{{site.github.url}}/assets/img/spring-cloud/gateway-keycloack/add-realm.png" width="100%" height="100%"/>

Create a client scope.

<img src="{{site.github.url}}/assets/img/spring-cloud/gateway-keycloack/client-scope.png" width="100%" height="100%"/>

Create two clients with the same configuration, one called `has-game-scope` and other called `no-game-scope`.

<img src="{{site.github.url}}/assets/img/spring-cloud/gateway-keycloack/add-client.png" width="100%" height="100%"/>

Assign the scope `GAME` for the client called `has-game-scope`.

<img src="{{site.github.url}}/assets/img/spring-cloud/gateway-keycloack/assign-scope.png" width="100%" height="100%"/>
...
Basically when accessing `http://localhost:9090`, Spring Boot prompts a login page asking for the scopes you want to use, depending on which one you select,
you be able to access the protected game api endpoint.

<img src="{{site.github.url}}/assets/img/spring-cloud/gateway-keycloack/diagram.png" width="100%" height="100%"/>
