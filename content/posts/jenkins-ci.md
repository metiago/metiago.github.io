...
{{< figure src="/img/ci/git_plugin.png" width="auto" >}}
...
{{< figure src="/img/ci/git_ssh.png" width="auto" >}}
...
{{< figure src="/img/ci/git_public_key.png" width="auto" >}}

In order to be able to trigger Jenkins' jobs, we should generate a Jenkins token. 

{{< figure src="/img/ci/jenkins_token.png" width="auto" >}}
...
{{< figure src="/img/ci/git_webhook.png" width="auto" >}}

Next step, create a job and set the SCM.

{{< figure src="/img/ci/job_git.png" width="auto" >}}

and then the Build Triggers
{{< figure src="/img/ci/job_trigger.png" width="auto" >}}
...
```
{{< figure src="/img/ci/job_build.png" width="auto" >}}
...
{{< figure src="/img/ci/job_started.png" width="auto" >}}

After the build, we're able to see the code quality analysis on SonarQube.

{{< figure src="/img/ci/sonar_report.png" width="auto" >}}
