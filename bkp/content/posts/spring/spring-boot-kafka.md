...
Here we go! Let's apply some tests... First we have to set up a Kafka Server for development - [Example Here](https://metiago.github.io/2019/06/22/kafka-single-node.html?query=kafka)
