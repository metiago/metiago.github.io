...
Simple reference to implement a basic I18N in Java

##### Below is a Java class responsible to read a properties file according to the language - JavaInternationalizationExample.java
...
##### Create 3 files propertie with the given content
```java
# 1. ApplicationMessages.properties
CountryName=USA
CurrencyCode=USD

# 2. ApplicationMessages_sv_SE.properties
CountryName=Sweden
CurrencyCode=Kr

# 3. ApplicationMessages_fr_FR.properties
CountryName=France
CurrencyCode=Euro
